...
public class Home extends HttpServlet {
    ...
    public void generateTableElement(PrintWriter writer) {
        ...
        writer.println("<div class=\"left-column\"><table><tr><th>Sigle</th><th>Nom</th></tr><tbody>");
        List<CryptoMoney> list = CryptoMoney.listAll();
        for (CryptoMoney crypto : list) {
            writer.println("<tr><td><a href=\"http://localhost:8080/api/cryptoMoney/cours/"+crypto.miniIdMonnaieCrypto+"\">" + crypto.miniIdMonnaieCrypto + "</a></td><td>" + crypto.nomMonnaieCrypto + "</td></tr>");
        }
